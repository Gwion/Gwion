...
SFUN(std_rand2)
{
  ...
  if ( range == 0 )
    ...
    if( range > 0 )
      RETURN->v_uint = min + (m_int)( (1.0 + range) * ( rand() / (RAND_MAX + 1.0) ) );
    else
      RETURN->v_uint = min - (m_int)( (-range + 1.0) * ( rand() / (RAND_MAX + 1.0) ) );
  }
}

SFUN(std_randf)
{
  RETURN->v_float = 2.0 * rand() / RAND_MAX - 1.0;
}
...
SFUN(std_rand2f)
{
  ...
  RETURN->v_float = min + (max - min) * (rand() / (m_float)RAND_MAX);
}
...
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_uint = ret < 0. ? -1 : ret > 0. ? 1 : 0;
}

SFUN(std_sin)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = sin(ret);
}

SFUN(std_cos)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = cos(ret);
}

SFUN(std_tan)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = tan(ret);
}

SFUN(std_asin)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = asin(ret);
}

SFUN(std_acos)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = acos(ret);
}

SFUN(std_atan)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = atan(ret);
}

SFUN(std_sinh)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = sinh(ret);
}

SFUN(std_cosh)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = cosh(ret);
}

SFUN(std_tanh)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = tanh(ret);
}
...
SFUN(std_atan2)
{
  ...
  RETURN->v_float = atan2(ret1, ret2);
}
...
SFUN(std_hypot)
{
  m_float ret1 = *(m_float*)(shred->mem + SZ_FLOAT);
  m_float ret2 = *(m_float*)(shred->mem + SZ_FLOAT * 2);
  RETURN->v_float = hypot(ret1, ret2);
}
...
SFUN(std_pow)
{
  m_float ret1 = *(m_float*)(shred->mem + SZ_FLOAT);
  m_float ret2 = *(m_float*)(shred->mem + SZ_FLOAT * 2);
  RETURN->v_float = pow(ret1, ret2);
}

SFUN(std_sqrt)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = sqrt(ret);
}

SFUN(std_exp)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = exp(ret);
}

SFUN(std_log)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = log(ret);
}

SFUN(std_log2)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = log2(ret);
}

SFUN(std_log10)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = log10(ret);
}

SFUN(std_floor)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = floor(ret);
}
...
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = round(ret);
}

SFUN(std_trunc)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_float = trunc(ret);
}
...
SFUN(std_remainder)
{
  m_float ret1 = *(m_float*)(shred->mem + SZ_FLOAT);
  m_float ret2 = *(m_float*)(shred->mem + SZ_FLOAT * 2);
  RETURN->v_float = remainder(ret1, ret2);
}
...
SFUN(std_min)
{
  m_float ret1 = *(m_float*)(shred->mem + SZ_FLOAT);
  m_float ret2 = *(m_float*)(shred->mem + SZ_FLOAT * 2);
  RETURN->v_float = ret1 < ret2 ? ret1 : ret2;
}
...
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_uint = isinf(ret);
}

SFUN(std_isnan)
{
  m_float ret = *(m_float*)(shred->mem + SZ_FLOAT);
  RETURN->v_uint = isnan(ret);
}
SFUN(std_clamp)
{
  ...
  RETURN->v_uint = ret < min ? min : ret > max ? max : ret;
}
...
SFUN(std_clampf)
{
  ...
  RETURN->v_float = ret < min ? min : ret > max ? max : ret;
}
...
SFUN(std_scale)
{
  ...
  RETURN->v_float = min2 + (max2 - min2) * ((ret - min1) / (max1 - min1));
}
...
SFUN(std_setenv)
{
  ...
  RETURN->v_uint = setenv(key, value, 1);
}
...
SFUN(std_mtof)
{
  RETURN->v_float = mtof(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_ftom)
{
  RETURN->v_float = ftom(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_powtodb)
{
  RETURN->v_float = powtodb(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_rmstodb)
{
  RETURN->v_float = rmstodb(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_dbtopow)
{
  RETURN->v_float = dbtopow(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_dbtorms)
{
  RETURN->v_float = dbtorms(*(m_float*)(shred->mem + SZ_FLOAT));
}

SFUN(std_dbtolin)
{
  RETURN->v_float = pow(10.0, *(m_float*)(shred->mem + SZ_FLOAT) / 20.0);
}

SFUN(std_lintodb)
{
  RETURN->v_float = 20.0 * log10(*(m_float*)(shred->mem + SZ_FLOAT));
}
...
SFUN(sndfile_size)
{
  ...
  RETURN->v_uint = file ? sfinfo.frames / sfinfo.channels : 0;
  if(file)
    sf_close(file);
}
