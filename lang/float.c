...
static INSTR(assign)
{
  ...
  *(m_float*)(shred->reg) = (**(m_float**)shred->reg = *(m_float*)(shred->reg + SZ_FLOAT));
  shred->reg += SZ_FLOAT;
}
...
// arithmetic
	CHECK_BB(add_binary_op(env, op_assign,        &t_float, &t_float, &t_float, assign,    0))
	CHECK_BB(add_binary_op(env, op_plus,          &t_float, &t_float, &t_float, plus,      0))
	CHECK_BB(add_binary_op(env, op_minus,         &t_float, &t_float, &t_float, minus,     0))
	CHECK_BB(add_binary_op(env, op_times,         &t_float, &t_float, &t_float, timesf,    0))
	CHECK_BB(add_binary_op(env, op_divide,        &t_float, &t_float, &t_float, divide,    0))
/*	CHECK_BB(add_binary_op(env, op_percent,       &t_float, &t_float, &t_float, modulo,     0))*/
// logical
	...
	CHECK_BB(add_binary_op(env, op_lt, 			 	    &t_float, &t_float, &t_int, lt,          0))
...
// reverse arithmetic
	...
	CHECK_BB(add_binary_op(env, op_minus_chuck,   &t_float, &t_float, &t_float, r_minus,   0))
	CHECK_BB(add_binary_op(env, op_times_chuck,   &t_float, &t_float, &t_float, r_times,   0))
	CHECK_BB(add_binary_op(env, op_divide_chuck,  &t_float, &t_float, &t_float, r_divide,  0))
...
// int to float
  // arithmetic
	...
	CHECK_BB(add_binary_op(env, op_divide,        &t_int, &t_float, &t_float, if_divide,   0))
  // logical
	CHECK_BB(add_binary_op(env, op_and,           &t_int, &t_float, &t_int, if_and,        0))
	CHECK_BB(add_binary_op(env, op_or,            &t_int, &t_float, &t_int, if_or,         0))
	CHECK_BB(add_binary_op(env, op_eq, 			 		  &t_int, &t_float, &t_int, if_eq,         0))
	CHECK_BB(add_binary_op(env, op_neq, 			 	  &t_int, &t_float, &t_int, if_neq,        0))
	CHECK_BB(add_binary_op(env, op_gt, 			 	    &t_int, &t_float, &t_int, if_gt,         0))
	CHECK_BB(add_binary_op(env, op_ge, 			 	    &t_int, &t_float, &t_int, if_ge,         0))
	CHECK_BB(add_binary_op(env, op_lt, 			 	    &t_int, &t_float, &t_int, if_lt,         0))
	CHECK_BB(add_binary_op(env, op_le, 			 	    &t_int, &t_float, &t_int, if_le,         0))
// reverse arithmetic
	CHECK_BB(add_binary_op(env, op_chuck,         &t_int, &t_float, &t_float, ifr_assign,  0))
	CHECK_BB(add_binary_op(env, op_plus_chuck,    &t_int, &t_float, &t_float, ifr_plus,    0))
	CHECK_BB(add_binary_op(env, op_minus_chuck,   &t_int, &t_float, &t_float, ifr_minus,   0))
	CHECK_BB(add_binary_op(env, op_times_chuck,   &t_int, &t_float, &t_float, ifr_times,   0))
	CHECK_BB(add_binary_op(env, op_divide_chuck,  &t_int, &t_float, &t_float, ifr_divide,  0))
...
/*	CHECK_BB(add_binary_op(env, op_plus,          &t_float,  &t_int,  &t_float, if_assign, 0))*/
	...
	CHECK_BB(add_binary_op(env, op_divide,        &t_float,  &t_int,  &t_float, fi_divide, 0))
  // logical
	CHECK_BB(add_binary_op(env, op_and,           &t_float, &t_int, &t_int, fi_and,        0))
	CHECK_BB(add_binary_op(env, op_or,            &t_float, &t_int, &t_int, fi_or,         0))
	CHECK_BB(add_binary_op(env, op_eq, 			 		  &t_float, &t_int, &t_int, fi_eq,         0))
	CHECK_BB(add_binary_op(env, op_neq, 			 	  &t_float, &t_int, &t_int, fi_neq,        0))
	CHECK_BB(add_binary_op(env, op_gt, 			 	    &t_float, &t_int, &t_int, fi_gt,         0))
  ...
  CHECK_BB(add_global_type(env, &t_dur))
	CHECK_BB(add_binary_op(env, op_chuck,        &t_dur,  &t_dur, &t_dur, r_assign, 0))
...
/*	CHECK_BB(add_binary_op(env, op_chuck,        &t_time, &t_dur, &t_dur, assign, 0))*/
	...
	CHECK_BB(add_binary_op(env, op_chuck,        &t_time, &t_time, &t_time, r_assign, 0))
	CHECK_BB(add_binary_op(env, op_chuck,        &t_dur,  &t_time, &t_time, r_assign, 0))
	CHECK_BB(add_binary_op(env, op_chuck,        &t_dur,  &t_now,  &t_time, Time_Advance, 0))
	CHECK_BB(add_binary_op(env, op_plus,         &t_time, &t_dur,  &t_time, plus,   0))
	CHECK_BB(add_binary_op(env, op_plus,         &t_dur,  &t_time, &t_time, plus,   0))
	CHECK_BB(add_binary_op(env, op_gt,           &t_time,  &t_time, &t_time, gt,   0))
	CHECK_BB(add_binary_op(env, op_ge,           &t_time,  &t_time, &t_time, ge,   0))
	CHECK_BB(add_binary_op(env, op_lt,           &t_time,  &t_time, &t_time, lt,   0))
	CHECK_BB(add_binary_op(env, op_le,           &t_time,  &t_time, &t_time, le,   0))
