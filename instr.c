...
//	exit(12);
 // prev_stack = 0;
//else
//if((m_uint*)(shred->mem - SZ_INT) < (m_uint*)shred->mem)
//{
//  prev_stack = 0;
//}
//	exit(2);
...
//printf("push %lu stack_depth %lu\n", push, stack_depth);
  ...
  *(m_uint*)(shred->mem)  = (m_uint)stack_depth;
  //*(m_uint*)(shred->mem)  = (m_uint)stack_depth;
  /*//  *(m_uint*)(shred->mem)  = (m_uint)stack_depth + (func->need_this ? SZ_INT: 0);*/
  PUSH_MEM(shred,  SZ_INT);

  shred->next_pc = 0;
  shred->code = func;
printf("push %lu stack_depth %lu\n", push, stack_depth);
printf("push %lu stack_depth %lu\n", push, *(m_uint*)(shred->mem -SZ_INT));
  if(stack_depth)
  {
...
//printf("this %p %i\n", *(m_uint*)(shred->reg + stack_depth - SZ_INT*2), stack_depth);

		*(m_uint*)(shred->mem) = *(m_uint*)(shred->reg + stack_depth - SZ_INT);
//		*(m_uint*)(mem) = *(m_uint*)(shred->reg + stack_depth - SZ_INT);
...
//  PUSH_MEM(shred,  prev_stack + local_depth);
//  PUSH_MEM(shred,  4 * SZ_INT);
...
#endif
printf("%p %p\n", *(M_Object*)(shred->mem -SZ_INT*2) , *(M_Object*)(shred->mem + instr->m_val + SZ_INT*6));
