...
typedef enum { Decl_Expression_type, Binary_Expression_type, Unary_Expression_type, Primary_Expression_type,
  ...
  If_Expression_type, Dot_Member_type, Dur_Expression_type} Expression_type;
...
struct Stmt_List_ { Stmt* stmt; Stmt_List next; int pos; };
...
struct Class_Ext_  { ID_List extend_id; ID_List impl_list; int pos; };
struct Class_Body_ { Section* section; Class_Body next; int pos; };
...
struct Ast_ { Section* section; Ast next; int pos; m_str doc; };
