...
m_bool import_complex(Importer importer) {
  ...
  CHECK_BB(importer_class_end(importer))
  CHECK_BB(importer_add_op(importer,  op_assign,        "complex", "complex", "complex", complex_assign,     0))
  CHECK_BB(importer_add_op(importer,  op_plus,          "complex", "complex", "complex", complex_plus,       0))
  CHECK_BB(importer_add_op(importer,  op_minus,         "complex", "complex", "complex", complex_minus,      0))
  CHECK_BB(importer_add_op(importer,  op_times,         "complex", "complex", "complex", complex_times,      0))
  CHECK_BB(importer_add_op(importer,  op_divide,        "complex", "complex", "complex", complex_divide,     0))
  CHECK_BB(importer_add_op(importer,  op_chuck,         "complex", "complex", "complex", complex_r_assign,   0))
  CHECK_BB(importer_add_op(importer,  op_plus_chuck,    "complex", "complex", "complex", complex_r_plus,     0))
  CHECK_BB(importer_add_op(importer,  op_minus_chuck,   "complex", "complex", "complex", complex_r_minus,    0))
  CHECK_BB(importer_add_op(importer,  op_times_chuck,   "complex", "complex", "complex", complex_r_times,    0))
  CHECK_BB(importer_add_op(importer,  op_divide_chuck,  "complex", "complex", "complex", complex_r_divide,   0))
  CHECK_BB(importer_add_op(importer,  op_assign,        "polar", "polar", "polar", complex_assign,           0))
  CHECK_BB(importer_add_op(importer,  op_chuck,         "polar", "polar", "polar", complex_r_assign,         0))
  CHECK_BB(importer_add_op(importer,  op_plus,          "polar", "polar", "polar", polar_plus,       0))
  CHECK_BB(importer_add_op(importer,  op_minus,         "polar", "polar", "polar", polar_minus,      0))
  CHECK_BB(importer_add_op(importer,  op_times,         "polar", "polar", "polar", polar_times,      0))
  CHECK_BB(importer_add_op(importer,  op_divide,        "polar", "polar", "polar", polar_divide,     0))
  CHECK_BB(importer_add_op(importer,  op_plus_chuck,    "polar", "polar", "polar", polar_plus_r,     0))
  CHECK_BB(importer_add_op(importer,  op_minus_chuck,   "polar", "polar", "polar", polar_minus_r,    0))
  CHECK_BB(importer_add_op(importer,  op_times_chuck,   "polar", "polar", "polar", polar_times_r,    0))
  CHECK_BB(importer_add_op(importer,  op_divide_chuck,  "polar", "polar", "polar", polar_divide_r,   0))
  return 1;
}
