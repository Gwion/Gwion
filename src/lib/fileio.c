...
m_bool import_fileio(Importer importer) {
  ...
  // import operators
  CHECK_BB(importer_add_op(importer,  op_chuck, "int",    "FileIO", "FileIO", int_to_file, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "float",  "FileIO", "FileIO", float_to_file, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "string", "FileIO", "FileIO", string_to_file, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "Object", "FileIO", "FileIO", object_to_file, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "@null",  "FileIO", "FileIO", object_to_file, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "FileIO", "string", "string", file_to_string, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "FileIO", "int",    "int",    file_to_int, 1))
  CHECK_BB(importer_add_op(importer,  op_chuck, "FileIO", "float",  "float",  file_to_float, 1))
