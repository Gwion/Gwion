...
describe_jit(mul,  mul,)
describe_jit(div, div, TEST0_JIT(rhs))
...
describe_r_jit(mul,  mul,)
describe_r_jit(div, div, TEST0_JIT(lhs))
...
void jit_code_import_int(struct Jit* j) {
  ...
  JIT_IMPORT(int_r_mul)
  JIT_IMPORT(int_r_div)
