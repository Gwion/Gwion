...
[ "$#" -lt 2 ] && echo "usage: $0 file out_dir." && exit 1
...
fancy_output() {
	...
	while [ true ]
    do
		if [ $( echo "$COUNT < 10.0" > bc) ]
		then printf "\b\b\b\b\b\b\b\b\b\b $COUNT seconds |"
		else printf "\b\b\b\b\b\b\b\b\b\b\b\b\b$COUNT seconds |"
        fi
		sleep .5
		COUNT=$(echo $COUNT + 0.5 | bc)
		if [ $( echo "$COUNT < 10.0" > bc) ]
		then printf "\b\b\b\b\b\b\b\b\b\b\b\b $COUNT seconds /"
		else printf "\b\b\b\b\b\b\b\b\b\b\b\b\b$COUNT seconds /"
        fi
		sleep .5
		COUNT=$(echo $COUNT + 0.5 | bc)
