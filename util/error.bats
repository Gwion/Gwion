...
@test "enum already defined as var"        { gbt enum_defined2.gw   "already declared"; }
@test "enum already defined as var"        { gbt enum_defined3.gw   "already declared"; }
...
@test "func pointer already defined"       { gbt ptr_defined.gw   "has already been defined in the same scope"; }
@test "func pointer 0 size argument"       { gbt ptr_arg_0_size.gw   "cannot declare variables of size '0'"; }
@test "func pointer reference primitive"   { gbt ptr_ref_prim.gw   "cannot declare references (@) of primitive type"; }
...
@test "nested function"                    { skip "this fail at compiler level"  gbt function_nested.gw   "nested function definitions are not (yet) allowed;"; }
...
@test "incompatible array subscript"         { gbt no_compat_sub.gw   "must be of type 'int'"; }
@test "incompatible array subscript"         { gbt no_compat_sub2.gw   "incompatible array subscript type"; }
@test "undefined parent class"               { gbt undef_parent.gw   "undefined parent class"; }
@test "undefined parent class"               { gbt prim_parent.gw   "cannot extend primitive"; }
...
@test "declare in GACK "                     { gbt gack_decl.gw   "cannot use <<< >>> on variable declarations"; }
@test "declare in GACK "                     { gbt gack_decl2.gw   "can't declare in GACK"; }
@test "static variable outside class"        { gbt static_out.gw   "static variables must be declared at class scope"; }
@test "provide array"                        { gbt provide_array.gw   "must provide values/expressions for array [...]"; }
...
@test "complex invalid real"                 { gbt complex_invalid_re.gw   "in real component of complex value"; }
@test "complex invalid real"                 { gbt complex_invalid_im.gw   "in imaginary component of complex value"; }
...
@test "assign function ptr"                  { gbt ptr_assign.gw   "can't assign function pointer to function pointer for the moment. sorry."; }
...
@test "assign non member function ptr"       { gbt ptr_assign_member.gw   "can't assign member function to non member function pointer"; }
@test "assign non member function ptr"       { gbt ptr_assign_global.gw   "can't assign non member function to member function pointer"; }
