...
#done
{
	...
	echo "\$_arg_cc -Iinclude \$_arg_soundpipe_inc -DDEBUG \$_CFLAGS util/generate_header.c core/err_msg.c -o util/generate_header || (echo 'invalid compilation options'; exit 1;)"
