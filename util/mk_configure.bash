...
#done
{
	...
	echo "\$_arg_cc -Iinclude -DDEBUG \$_CFLAGS \${_arg_soundpipe_inc} util/generate_header.c core/err_msg.c -o util/generate_header || (echo 'invalid compilation options'; exit 1;)"
